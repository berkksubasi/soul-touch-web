  ...
  return (
    <header className="h-screen text-black flex items-center">
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center justify-between">
        ...
        <a
          href="#"
          className="bg-blue-500 hover:bg-gray-700 text-white py-3 px-4 rounded-lg shadow-md text-lg font-medium flex items-center space-x-2 transition-transform duration-300 hover:scale-105"
        >
        ...
        <a
          href="#"
          className="bg-green-500 hover:bg-gray-700 text-white py-3 px-4 rounded-lg shadow-md text-lg font-medium flex items-center space-x-2 transition-transform duration-300 hover:scale-105"
        >
